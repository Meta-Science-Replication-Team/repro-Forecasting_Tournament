...
DF_actual <- import("../original_files/historical_data.csv") %>% 
	select(-V1) %>% 
...
DF_predicted_1 <- import("../original_files/Wave1+2data.csv") %>%
	filter(phase == 1) %>% 
...
DF_predicted_2 <- import("../original_files/Wave1+2data.csv") %>%
	filter(phase == 2) %>% 
