...
:::
**Correct. Note, as transparently mentioned in the manuscript,** *due to scale differences between domains, [the authors] chose not to feature analyses concerning absolute percentage errors of each time point in the main paper.*
